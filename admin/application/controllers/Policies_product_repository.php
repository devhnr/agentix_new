<?php
	...
	$data['all_company_name'] = $this->policies_product_repository_model->alldata("company_name");		$data['policy_category'] = $this->policies_product_repository_model->alldata("policy_category");
