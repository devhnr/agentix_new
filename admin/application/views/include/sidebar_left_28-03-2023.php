          ...
          <!--   <?php if(in_array('21',$permission1)){ ?>
           ...
           <li><a class="ajax-disable" href="<?php echo $base_url;?>wallet/lists"><span
            ...
            <li class="divider"></li>
             ...
             <li><a class="ajax-disable" href="<?php echo $base_url;?>solutions/lists"><span style="font-size:14px;" class="glyphicons glyphicons-book"></span>Solutions</a></li>    
            ...
            <li class="divider"></li> 
             ...
             <li><a class="ajax-disable" href="<?php echo $base_url;?>what_we_do/lists"><span style="font-size:14px;" class="glyphicons glyphicons-book"></span>What We Do</a></li>    
            ...
            <li class="divider"></li>
             ...
             <li><a class="ajax-disable" href="<?php echo $base_url;?>key_client/lists"><span style="font-size:14px;" class="fa fa-lock"></span>Key Clientele</a></li>    
            ...
            <li class="divider"></li>
             ...
             <li><a class="ajax-disable" href="<?php echo $base_url;?>claim_enquiry/lists"><span style="font-size:14px;" class="fa fa-lock"></span>Claim Enquiry</a></li>    
			...
			<li><a class="ajax-disable" href="<?php echo $base_url;?>quote/lists"><span style="font-size:14px;" class="fa fa-lock"></span>Corporate Cyber - Get Quote</a></li>

            <li><a class="ajax-disable" href="<?php echo $base_url;?>book_demo/lists"><span style="font-size:14px;" class="fa fa-lock"></span>Corporate Cyber - Book Demo</a></li>    
