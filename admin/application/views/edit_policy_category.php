                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>policy_category/edit/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_policy_category">
									...
									<div class="form-group">
									  ...
									  <img src="<?php echo $front_base_url; ?>upload/policy_category/large/<?php echo $icon; ?>" height="50" width="50">
									</div>
									<!--
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>policy_category/lists" class="submit btn bg-purple pull-right"
