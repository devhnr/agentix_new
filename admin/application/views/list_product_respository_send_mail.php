        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Product Repository Send Mail</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Product Repository Send Mail</li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Product Repository Send Mail Listing </span> </div>
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $this->product_respository_send_mail_model->get_agent_name($result[$i]->agent_id);?>
                                                    
                                                </td>
												
												<td>
                                                    <?php echo $this->product_respository_send_mail_model->get_policy_name($result[$i]->policy_id);?>
