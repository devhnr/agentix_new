    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit New Products </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>new_products/lists">New Products</a></li>
                    <li class="crumb-trail">Edit New Products</li>
                </ol>
            </div>
        </div>
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit New Products</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>new_products/edit/<?php echo $id; ?>"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_new_products">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="<?php echo $compare_name->id; ?>"
                                            <?php if($compare_name->id==$company_id){ echo "selected";} ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control"
                                            placeholder="Enter Product Name" value="<?php echo $name; ?>" />
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <textarea type="text" id="description" name="description" class="form-control" placeholder="Enter Description"><?php echo $description; ?></textarea>
								...
								<div class="form-group">
                                        ...
                                        <input id="url" name="url" type="text" class="form-control"
                                            placeholder="Enter Link" value="<?php echo $url; ?>" />
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>new_products/lists" class="submit btn bg-purple pull-right"
