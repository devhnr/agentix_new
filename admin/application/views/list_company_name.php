        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Company</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Company</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>company_name/add/" class="btn btn-alert pull-right"><i
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Company Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."company_name/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."company_name/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'company_name/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>company_name/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'company_name/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of Company');

    if (t) {

        window.location.href = '<?php echo $base_url;?>company_name/updateorder/' + id + '/' + val;
