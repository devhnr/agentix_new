        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Poster</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Poster</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>poster/add/" class="btn btn-alert pull-right"><i
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Poster Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."poster/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="<?php echo $front_base_url; ?>upload/poster/medium/<?php echo $result[$i]->image; ?>"
                                                ...
                                                <td class="left">
													...
													<?php 
														if($result[$i]->recomanded =='yes') { 
															echo "Yes";
														}elseif($result[$i]->recomanded =='no'){
															echo "No";
														}else{
															echo "-";
														}
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."poster/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'poster/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>poster/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'poster/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of Poster');

    if (t) {

        window.location.href = '<?php echo $base_url;?>poster/updateorder/' + id + '/' + val;
