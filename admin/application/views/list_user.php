...
<!-- Start: Main --><div id="main">   
 ...
 <li class="crumb-active">
 	...
 	<a href="javascript:void(0);">User</a></li>         
 ...
 <span class="glyphicon glyphicon-list-alt"></span>User Listing </span> 
 ...
 <td><?php echo $result[$i]->fname; ?></td>	  

 <td><?php echo $result[$i]->email; ?></td>              

 <td><?php echo $result[$i]->mobile; ?></td>	

 <td><?php echo date('d/m/Y G:i',strtotime($result[$i]->added_date));?></td>	
