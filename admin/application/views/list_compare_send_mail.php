        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Compare Send Mail</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Compare Send Mail</li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Compare Send Mail Listing </span> </div>
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $this->compare_send_mail_model->get_agent_name($result[$i]->agent_id);?>
												...
												<td><a href="<?php echo $result[$i]->url ?>" target="_blank"><?php echo $result[$i]->url ?></a></td>
												<td><?php echo $result[$i]->added_date ?></td>
