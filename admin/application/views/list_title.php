        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Title</a></li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>title/add/" class="btn btn-alert pull-right"><i
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Title Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."title/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $this->title_model->get_compare_name($result[$i]->compare_id); ?>
                                                </td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."title/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'title/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>title/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'title/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of Title');

    if (t) {

        window.location.href = '<?php echo $base_url;?>title/updateorder/' + id + '/' + val;
