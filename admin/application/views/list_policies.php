        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Policies</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span

                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Policies</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>policies/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Policies</a>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>Policies </span> </div>


                        <div class="panel-body">

                            <form action="<?php echo $base_url."policies/deletes";?>" method="post" enctype="multipart/form-data" id="form">
					...
					for($i=0;$i<count($result);$i++){ ?>
                                            ...
                                            <input type="checkbox"  name="selected[]" id="selected[]" value="<?php echo $result[$i]['id']; ?>" class="minimal-red"></td>
												<td><?php echo $this->policies_model->get_category_name($result[$i]['cat_id']); ?>                                                </td>																								
                                               <td><?php echo $this->policies_model->get_company_name($result[$i]['company_id']); ?>
                                                </td>																								
                                                <td><?php echo $result[$i]['plan_name']; ?></td>
                                                 <td><?php echo $this->policies_model->get_sum_insured_name($result[$i]['sum_insured_id']); ?>
                                                </td>
                                                <!-- <td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."policies/edit/"; ?><?php echo $result[$i]['id'];?>">
...
function updateorder_status(id, value) {
    if (value.checked) {
        ...
        var base_url = '<?php echo $base_url. 'policies/updateorder_status';?>';
...
<script>
 function updateorder(val,id){
            ...
            if(t){
                window.location.href='<?php echo $base_url;?>policies/updateorder/'+id+'/'+val;
            }else {
                return false;
            }
        }
