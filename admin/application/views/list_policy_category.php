        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Category</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Category</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>policy_category/add/" class="btn btn-alert pull-right"><i
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Category Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."policy_category/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
												...
												<td>
													<?php if($result[$i]->icon != ''){?>
													<img src="<?php echo $front_base_url.'/upload/policy_category/large/'.$result[$i]->icon;?>" width="50" height="50" />
													<?php } else { echo "-";}?>
												</td> 
                                             ...
                                             <!--    <td>
                                                ...
                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."policy_category/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'policy_category/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>policy_category/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'policy_category/featured_product';?>';
...
function updateorder(val, id) {
    ...
    if (t) {
        ...
        window.location.href = '<?php echo $base_url;?>policy_category/updateorder/' + id + '/' + val;
