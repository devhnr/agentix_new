    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit Title </a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>title/lists">Title</a></li>
                    <li class="crumb-trail">Edit Title</li>
                </ol>
            </div>
        </div>
        <div id="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Title</span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post"
                                    action="<?php echo $base_url;?>title/edit/<?php echo $id; ?>"
                                    ...
                                    <div class="form-group">
                                        <label style="width:100%;" for="product_name">Compare Name</label>
                                        <select name="compare_id" id="compare_id" class="form-control" placeholder="Select Compare Name" />
                                        <option value=''>Select Compare Name</option>
                                        <?php  if($all_compare_name !='' && count($all_compare_name) > 0){ 
                                        foreach($all_compare_name as $compare_name){ 
                                        ?>
                                        <option value="<?php echo $compare_name->id; ?>"
                                            <?php if($compare_name->id==$compare_id){ echo "selected";} ?>>
                                            <?php echo $compare_name->name; ?>
                                        </option>
                                        <?php } } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>title/lists" class="submit btn bg-purple pull-right"
