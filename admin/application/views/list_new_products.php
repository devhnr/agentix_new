        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">New Products</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">New Products</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>new_products/add/" class="btn btn-alert pull-right"><i
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span>New Products Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."new_products/deletes";?>" method="post"
                  ...
                  if($result){
					...
					for($i=0;$i<count($result);$i++){
                        // echo "<pre>";print_r($result[$i]->name);echo "</pre>";exit;
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $this->new_products_model->get_company_name($result[$i]->company_id); ?>
                                                </td>
                                                <td><?php echo $result[$i]->name; ?></td>

                                                <td class="left"><?php echo $result[$i]->url; ?>
                                                </td>



                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."new_products/edit/"; ?><?php echo $result[$i]->id; ?>">
...
$(document).ready(function($) {
    ...
    $('#reset').click(function() {
        ...
        var base_url = '<?php echo $base_url.'new_products/lists'; ?>';
    ...
    $.ajax({
        ...
        url: '<?php echo $base_url; ?>new_products/ajaxlist_country',
...

{
...

    {
        ...
        var base_url = '<?php echo $base_url. 'new_products/featured_product';?>';
...
function updateorder(val, id) {
    ...
    var t = confirm('Are you sure you want to Set order of New Products');

    if (t) {

        window.location.href = '<?php echo $base_url;?>new_products/updateorder/' + id + '/' + val;
