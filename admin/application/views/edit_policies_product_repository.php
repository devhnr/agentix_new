        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);"> Edit Product Repository Policies</a></li>
                    ...
                    <li class="crumb-trail">Edit Product Repository Policies</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    ...
                                    class="glyphicon glyphicon-lock"></span> Edit Product Repository Policies</span> </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>policies_product_repository/edit/<?php echo $id; ?>" enctype="multipart/form-data">

                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="edit_policies_product_repository">
                                    <INPUT TYPE="hidden" NAME="hiddenaction" VALUE="<?php echo $id;?>">																											<div class="form-group">                                        <label style="width:100%;" for="product_name">Category</label>                                        <select name="cat_id" id="cat_id" class="form-control" />                                        <option value=''>Select Category</option>                                        <?php  if($policy_category !='' && count($policy_category) > 0){                                         foreach($policy_category as $policy_category_data){                                         ?>                                        <option value="<?php echo $policy_category_data->id; ?>"                                            <?php if($policy_category_data->id==$cat_id){ echo "selected";} ?>>                                            <?php echo $policy_category_data->name; ?>                                        </option>                                        <?php } } ?>                                        </select>                                    </div>
                            ...
                            <?php if ($sum_insuranc_data != '') { ?>
                                    ...
                                    <div class="col-md-12" style="display:none">
                                        ...
                                        <a href="#"
                                            onclick="singledelete05('<?php echo $base_url . "policies_product_repository/remove_sum_insuranc/"; ?><?php echo $sum_insuranc_data[$i]->sins_id; ?>/<?php echo $sum_insuranc_data[$i]->id; ?>');"
                                ...
                                <div class="col-md-12 " style="margin: 0;padding: 0;display:none">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="#"
                                            onclick="singledelete4('<?php echo $base_url . "policies_product_repository/remove_topFeature/"; ?><?php echo $top_feature_item[$i]->p_id; ?>/<?php echo $top_feature_item[$i]->id; ?>');"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="#"
                                            onclick="singledelete('<?php echo $base_url . "policies_product_repository/removeprice/"; ?><?php echo $addition_item[$i]->c_id; ?>/<?php echo $addition_item[$i]->id; ?>');"
                                            href="javascript:void(0);" style="margin-right: 87px; margin-top: 22px;"
                                            class="btn btn-danger pull-right"> Remove</a>
                                    </div>
                                ...
                                <div class="col-md-12 " style="margin: 0;padding: 0;display:none">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="#"
                                            onclick="singledelete1('<?php echo $base_url . "policies_product_repository/remove_exclusion/"; ?><?php echo $exclusion_item[$i]->excl_id; ?>/<?php echo $exclusion_item[$i]->id; ?>');"
                                            href="javascript:void(0);" style="margin-right: 87px; margin-top: 22px;"
                                            class="btn btn-danger pull-right"> Remove</a>
                                    </div>
                            ...
                            <div class="form-group" style="display:none">
                             ...
                             <div class="col-md-12 " style="margin: 0;padding: 0;">
                                    <h3 style="margin-top: 25px;margin-bottom: 0px;display:none">Compare Detail</h3>
                            <?php if ($addition_detail != '') { ?>
                                    ...
                                    <div class="col-md-12" style="display:none">
                                        ...
                                        <a href="#"
                                            onclick="singledelete3('<?php echo $base_url . "policies_product_repository/remove_compare/"; ?><?php echo $addition_detail[$i]->policies_id; ?>/<?php echo $addition_detail[$i]->id; ?>');"
                                            href="javascript:void(0);" style="/* margin-right: 87px; */ /* margin-top: 22px; */margin-bottom: 10px;"
                                            class="btn btn-danger pull-right"> Remove</a>
                                    </div>
                       ...
                       <div class="form-group">
                          ...
                          <input id="lost_wages2" <?php if($lost_wages2 == 2){echo "checked";}?> name="lost_wages2" type="radio" value="2" />&nbsp;NO
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo $base_url;?>policies_product_repository/lists" class="submit btn bg-purple pull-right"
...
<script type="text/javascript">
    ...
    var url = "<?php echo $base_url; ?>policies_product_repository/show_title_edit";
    $.ajax({
        url: url,
        type: 'post',
        data: 'id=' + id,
...
<script type="text/javascript">
    ...
    var url = "<?php echo $base_url; ?>policies_product_repository/show_title_update";
    $.ajax({
        url: url,
        type: 'post',
        data: 'id=' + id,
