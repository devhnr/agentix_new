        ...
        <div id="topbar">
            ...
            <div class="topbar-left">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-active"><a href="javascript:void(0);">Product Repository</a></li>

                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>

                    <li class="crumb-trail">Product Repository</li>
        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo $base_url;?>product_repository/add/" class="btn btn-alert pull-right"><i
                            class="fa fa-plus"></i> Add Product Repository</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-list-alt"></span> Product Repository Listing </span> </div>

                        <div class="panel-body">

                            <form action="<?php echo $base_url."product_repository/deletes";?>" method="post"
				...
				?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $this->product_repository_model->get_policy_name($result[$i]->policy_id);?>
                                                    
                                                </td>
                                                <td>
                                                    <?php 
                                                        if($result[$i]->document_type == 1){
                                                            echo "Wording";
                                                        }elseif($result[$i]->document_type == 2){
                                                            echo "Brochure";
                                                        }elseif($result[$i]->document_type == 3){
                                                            echo "Both";
                                                        }else{
                                                            echo "";
                                                        }
                                                ...
                                                <td>
                                                    <a href="<?php echo $front_base_url; ?>upload/product_repository/<?php echo $result[$i]->document_file; ?>" class="btn bg-purple2" target="_blank">View Document</a>
                                                </td>

                                                <td><a class="btn bg-purple2" title="Edit"
                                                        href="<?php echo $base_url."product_repository/edit/"; ?><?php echo $result[$i]->id; ?>">
