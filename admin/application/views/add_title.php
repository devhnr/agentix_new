    ...
    <section id="content_wrapper">
        <div id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    <li class="crumb-active"><a href="javascript:void(0);"> Add Title</a></li>
                    <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span
                                class="glyphicon glyphicon-home"></span></a></li>
                    <li class="crumb-link"><a href="<?php echo $base_url; ?>title/lists">Title</a></li>
                    <li class="crumb-trail">Add a Title</li>
                </ol>
            </div>
        </div>
        <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"> <span class="panel-title"> <span
                                    class="glyphicon glyphicon-lock"></span> Add Title </span> </div>
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <form role="form" id="form" method="post" action="<?php echo $base_url;?>title/add"
                                    enctype="multipart/form-data">
                                    <INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
                                    <INPUT TYPE="hidden" NAME="action" VALUE="add_title">

                                    <div class="form-group">
                                    <label for="blog_cate_id">Compare Name</label>
                                        <span id="prod1">
                                        <select id="compare_id" name="compare_id"  class="form-control">
                                  ...
                                  <!--   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $base_url;?>title/lists"
...
function validate() {
    ...
    if (compare_id == '') {
        ...
        $("#error_msg1").html("Please Select Compare Name.");
