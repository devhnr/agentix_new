                ...
                <div class="col-lg-12">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="back-btn">
                            ...
                            <a href="javascript:void(0)" id="backButton" class="btn"><i class="feather icon-feather-chevron-left"></i> Back</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="compare-tbl table  table-bordered ">
                            ...
                            <?php } ?>
								...
								/* echo "<pre>";print_r($blankArray);echo "</pre>";
								...
								//echo "<pre>";print_r($compare_name_data);echo "</pre>";
