        ...
        <table style="padding: 30px 20px; border-top: 2px solid #f7f7f7">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="2"><p style="margin: 0;margin-bottom: 3%;">I hope this message finds you well. We are committed to making your insurance decisions as easy as possible.</p></td>
                ...
                <tr>
                    ...
                    <td colspan="2"><p style="margin: 0;margin-bottom: 3%;">In line with this commitment, we have attached the Product documents for the below-listed products to help you make an informed decision for your insurance needs:</p></td>
                ...
                <tr>
                    ...
                    <td colspan="2"><p style="margin: 0;margin-bottom: 3%;"><?php echo $policy_name;?></p></td>
