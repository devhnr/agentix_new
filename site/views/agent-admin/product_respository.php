                ...
                <tbody>
                    ...
                    <?php foreach ($all_policy_repository as $all_policy_repository_data){ 
                        ...
                        //echo "<pre>";print_r($all_policy_repository_data);echo"</pre>";
							...
							$claim_forn_data = $this->agent_admin_model->policy_repository_data($policy_data->id,'4');
                    ...
                    <tr style="<?php echo $style; ?>">
						...
						<td>
                            <?php if($claim_forn_data->document_file != ''){ ?>
                            <a href="<?php echo $base_url?>agent_admin/policy_rep_doc_download/<?php echo $claim_forn_data->document_file?>" class="btn btn-success"><i class="feather icon-feather-download"></i></a>

                            <!-- <input type="checkbox" name="wording_checkbox[]" value="<?php echo $claim_forn_data->document_file?>"> -->
